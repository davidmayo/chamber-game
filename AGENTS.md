...
- The high bay is intentionally inaccessible. It uses the same simple low-poly vocabulary as the rest of the project, but serves as an alluring contrast to the mundane, drab working rooms: very tall, bright, cool-white, clean, gleaming, and slightly shiny, visible only through the DOC/hallway glazing. Preserve its high industrial ceiling, high-mounted lighting, reflective light-gray floor, and lack of any player entrance.
- The cleanroom is a sparse, sealed pavilion inside the high bay: a distinct glossy white floor and roughly 2-foot-thick low white ceiling held by dense silver metallic framing, with clear plexiglass walls and an intentionally excessive grid of cold-white lights. Its long axis runs away from the hallway. Interior plexiglass-and-metal partitions define one large central room and two smaller rooms at each end. Its overwhelming brightness should make it look intrinsically intriguing and beguiling from the overlook even while empty. Do not make it accessible or populate it with equipment unless explicitly requested.
