...
- The Ground Ops exterior is a deliberately forced-perspective stage set. The real dishes are roughly 2,500 feet (762 m) from the DOC, while their generated proxies use 1:10 diameters (2.1 m/1.3 m) and intentionally stylized placement. Preserve the dish complex's shared generated root offset `(-41.5, 13.7, 18.01)` unless the user moves it again. Nearby terrain begins around world `Y = -4.2`, making the Ops floor a second-story room, and rises to a broad shoulder around world `Y = 12.56` beneath the dishes. The exterior sightline is approximately world `(-X, +Z)`. The low-poly ridge is generated by `GroundOpsSceneBuilder`; keep exterior terrain and dishes separate from the room blockout and omit the intervening building unless explicitly requested.
