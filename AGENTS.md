...
- `RuntimeSceneSwitcher` provides a small persistent runtime overlay for loading either `Main` (Anechoic Chamber) or `GroundOps`; keep scene switching available from both levels.
