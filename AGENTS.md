...
- The high bay is intentionally inaccessible and should remain empty until explicitly requested. It uses the same simple low-poly vocabulary as the rest of the project, but serves as an alluring contrast to the mundane, drab working rooms: very tall, bright, cool-white, clean, gleaming, and slightly shiny, visible only through the DOC/hallway glazing. Preserve its high industrial ceiling, high-mounted lighting, reflective light-gray floor, and lack of any player entrance or equipment.
