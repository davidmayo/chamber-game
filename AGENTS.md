...
- The cleanroom is a sparse, sealed pavilion inside the high bay: a distinct glossy white floor and low white ceiling held by silver metallic framing, with clear plexiglass walls and an intentionally excessive grid of cold-white lights. Its overwhelming brightness should make it look intrinsically intriguing and beguiling from the overlook even while empty. Do not make it accessible or populate it with equipment unless explicitly requested.
