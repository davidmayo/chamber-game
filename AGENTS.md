...
- The Ground Ops exterior is a deliberately forced-perspective stage set. The real dishes are roughly 2,500 feet (762 m) from the DOC; their generated proxies use 1:10 diameters (2.1 m/1.3 m) but are staged only about 25.4 m away, making them read approximately three times closer/larger than reality. The exterior sightline is approximately world `(-X, +Z)`, along normalized horizontal direction `(-0.48, +0.88)`. The low-poly ridge is generated by `GroundOpsSceneBuilder`; keep exterior terrain and dishes separate from the room blockout and omit the intervening building unless explicitly requested.
